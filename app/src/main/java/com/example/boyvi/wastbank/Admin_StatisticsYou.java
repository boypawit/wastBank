...
public class Admin_StatisticsYou extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View headerView = navigationView.inflateHeaderView(R.layout.nav_header_main_admin1);
        TextView name = (TextView) headerView.findViewById(R.id.nav_name);

        ImageView imagepic =(ImageView) headerView.findViewById(R.id.pictureProfile1);
